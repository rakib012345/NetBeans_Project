...
public class Fishes {
 ...
 public static void main(String[] args) {
        FishesTable obj = new FishesTable();
        Button obj1 = new Button();
        obj1.setVisible(true);
    }
}
class FishesTable extends JFrame implements ActionListener{
    ...
    private String[] columns ={"Fishes Name","Rate/Kg","Buy","Sell"};
    ...
    private void initComponents() {
       ...
       JButton b3 = new JButton("Back");
        ...
        fnLable = new JLabel("Fishes Name");
