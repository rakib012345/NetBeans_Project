...
public class Dairy {
 ...
 public static void main(String[] args) {
        DairyTable obj = new DairyTable();
        Button obj1 = new Button();
        obj1.setVisible(true);
    }
}
class DairyTable extends JFrame implements ActionListener{
    ...
    private String[] columns ={"Dairy Name","Rate/Kg","Buy","Sell"};
