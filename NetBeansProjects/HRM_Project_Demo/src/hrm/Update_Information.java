...
public class Update_Information {
     Update_Employ obj4 = new Update_Employ();
}
class Update_Employ extends JFrame implements ActionListener{
...
private void initComponents()
       ...
       Font font2=new Font("f1",Font.BOLD+Font.ITALIC,20); 
       label6 = new JLabel("Give employee at home i you want to update");
       label6.setBounds(200,20,500,50);
       ...
       add(label6);
        ...
        label3.setBounds(40,500,300,50);
      ...
      //  designationField.setBackground(Color.GREEN);
        ...
        salaryField.setBounds(40,600,200,50);       
